...
if __name__ == "__main__":
    ...
    for cls in classes:
        for mode in modes:
            print(f"Processing class: {cls} with mode: {mode}")

            WORKING_DIR = f"./index_results/{cls}"
            QUERY_RESULTS_DIR = f"./query_results/{cls}"
            ...
            run_queries_and_save_to_json(
                ...
                rag,
                query_param,
                f"{QUERY_RESULTS_DIR}/result_{mode}.json",  
                f"{QUERY_RESULTS_DIR}/errors_{mode}.json",  
            )
